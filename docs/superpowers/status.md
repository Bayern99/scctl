...
- **Project Agent skills (Phase 7.2):** `.agents/skills/scctl-*` — procedural guides; spec in `docs/guides/agent-skills-spec.zh-CN.md`; human tutorial in `docs/guides/governed-pilot-tutorial.zh-CN.md`.
